  ...
  return (
    <div className="screen items-center justify-center text-center">
      <div className="flex-1 flex flex-col items-center justify-center w-full max-w-sm">
        ...
        <p className="text-white/50 mb-8">בוחר אצבעות מרובה משתתפים</p>
          ...
          <div className="w-full space-y-4">
            ...
            <div className="text-start">
              <div className="flex items-center justify-between mb-1">
                <span className="text-white/50 text-xs">דמות</span>
                <button
            ...
            <div className="text-start">
              <div className="flex items-center justify-between mb-1">
                <span className="text-white/50 text-xs">צבע</span>
                <button
        ...
        {!connected && (
          <p className="mt-4 text-amber-400 text-sm">מתחבר לשרת…</p>
        )}
      </div>
    </div>
  );
